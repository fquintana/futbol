...
class JugadorsControllerTest < ActionController::TestCase
  ...
  test "should create jugador" do
    assert_difference('Jugador.count') do
      post :create, jugador: { apellido: @jugador.apellido, apodo: @jugador.apodo, fecha_nacimiento: @jugador.fecha_nacimiento, nombre: @jugador.nombre, numero: @jugador.numero }
    end
  ...
  test "should update jugador" do
    put :update, id: @jugador, jugador: { apellido: @jugador.apellido, apodo: @jugador.apodo, fecha_nacimiento: @jugador.fecha_nacimiento, nombre: @jugador.nombre, numero: @jugador.numero }
    assert_redirected_to jugador_path(assigns(:jugador))
  end
